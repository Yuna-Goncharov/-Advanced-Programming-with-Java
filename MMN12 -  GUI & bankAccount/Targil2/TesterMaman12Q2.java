...
public class TesterMaman12Q2 {
    public static void main(String[] args) {
        // create an array of different bank accounts
        BankAccount[] accountsArray = {
                new ServiceChargeChecking("0001", "yosi", "031265489", 9000),
                new NoServiceChargeChecking("0002", "david", "031265321", 6000),
                new NoServiceChargeChecking("0003", "moshe", "031265345", 89000, 100),
                ...
                new HighInterestSavings("0009", "kobi", "037985489", 100, 200)
        };
        ...
        for (BankAccount accounts : accountsArray) {
            ...
            System.out.println(accounts);
            accounts.withdraw(r.nextInt(50000));
            System.out.println(accounts);
